...
Functionality: This class creates a node for the mesh network. It has various member functions.
    Member Functions: getID(self)
                                        Returns the ID of the given node.
                                    getStatus(self)
                                        Returns the status of the given node, such as active.
                                    setStatus(self, status)
                                        This function will set the status of the node.
                                    hasNeighbor()
                                        Checks to see if a given node is a dead end node, meaning that it has only one neighbor.
                                    checkNeighbor()
                                        Checks to see if the node only has one neighbor, or less than one neighbor.  If it does, then it is a dead end node.
                                        Otherwise, the dead end variable stays false, so it is still available.
                                    fail()
                                        Determines if a given node has failed.  It takes in a percent chance of failure, and generates a random number.
